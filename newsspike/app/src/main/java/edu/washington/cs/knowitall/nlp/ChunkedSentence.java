...
public class ChunkedSentence extends BIOLayeredSequence {
	...
	public ChunkedSentence(Range[] offsets, String[] tokens, String[] posTags,
		...
		this(ImmutableList.copyOf(offsets), ImmutableList.copyOf(tokens), ImmutableList.copyOf(posTags), ImmutableList
                ...
                System.out.println("CS: constructor: created ImmutableLists");

                for(String npct : npChunkTags){
                   System.out.println("CS constructor: " + npct);
                }

                for(Range range : offsets){
                   System.out.println("CS constructor: " + range.getStart() + ", " + range.getEnd());
                }

                for(String tok : tokens){
                   System.out.println("CS constructor: " + tok);          
                }

                for(String pos : posTags){
                   System.out.println("CS constructor: " + pos);          
                }
