...
public class Parsed2Tuple {
	...
	public static List<Tuple> getReverbTuples(FigerParsedSentence s) {
                ...
                System.out.println("P2T: getReverbTuples");
                System.out.println("P2T: fps len: " + s.len);
                System.out.println("P2T: fps blockNers: " + s.blockNers.size());
		...
		HashMap<Integer, OneNer> fnermap = new HashMap<Integer, OneNer>();
			...
			if (on.flabel.length() > 0) {
                ...
                System.out.println("P2T: reverbs: " + s.reverbs.size());
		...
		for (OneReverb or : s.reverbs) {
			...
			rmap.put(key, or);
                ...
                System.out.println("P2T: blockNers: " + s.blockNers.size());
		...
		for (int[] a : argStartEnds) {
			...
			if (t.getPatternList().size() > 0) {
                ...
                System.out.println("P2T: tuples size: " + tuples.size()); 
